...
const ListRow = ({ head = {}, body, uniqueId, status = {}, columns = [], ...props }) => {
      ...
      <div className="list">
        <div className="list__head">
          <div className="list__head__status">
            <Button
              className={`list__head__status__toggle ${isOpen && "active"} ${get(head, "statusColor") == "#FFD166" && "black"}`}
              bg={get(head, "statusColor")}
              hover={get(head, "statusColor")}
              xs
              semiBold
            ...
            >
              ...
              <Icon
                ...
                color={get(head, "statusColor") == "#FFD166" ? "#353945" : "white"}
              />
            </Button>
            <span>{0} LEAD</span>
                          ...
                          <Draggable key={item.id} draggableId={item.id} index={index}>
                            {(provided, snapshot) => (
                              ...
                              >
                                ...
                                {item.content == "phone" && (
                                  <Icon icon="icon-x-close" size="xs" className="xClose" color="white" />
                                )}
                              </div>
                            )}
                          </Draggable>
