...
import UpdateContainer from "../../containers/role/UpdateContainer";
...
const UpdatePage = ({ location: { pathname }, isSubmenuOpen, ...rest }) => {
  const dispatch = useDispatch();
  useEffect(() => {
    checkTab(dispatch, pathname, "Role update page");
  }, []);

  return (
    <UpdatePageStyle {...{ isSubmenuOpen }}>
      <UpdateContainer {...rest} />
    </UpdatePageStyle>
  );
};
