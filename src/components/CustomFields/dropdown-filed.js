...
const DropdownField = ({
  ...
  const [options, setOptions] = useState(getSelectOptionsListFromData(get(typeConfig, "options", []), "id", "name", "other"));
...
export default connect(mapStateToProps, mapDispatchToProps)(memo(DropdownField));
